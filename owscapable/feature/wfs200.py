...
#owslib imports:
from owscapable.ows import ServiceIdentification, ServiceProvider, OperationsMetadata
from owscapable.etree import etree
from owscapable.util import nspath, testXMLValue
from owscapable.crs import Crs
from owscapable.feature import WebFeatureService_
